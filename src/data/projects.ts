...
/** 「项目」区块的说明行。仓库上线后改这里，不动组件。 */
export const projectsMeta = {
  note: '两个系统的源码仓库正在整理中，会陆续公开；卡片目前指向我的 GitHub 主页。',
}
...
export const projects: Project[] = [
  {
    ...
    stack: ['Java 8', 'Servlet', 'MyBatis', 'MySQL', 'Druid', 'fastjson', 'Python', 'FastAPI'],
  ...
  },
  {
    ...
    description:
      'Spring Boot 3 + Vue 3 + Element Plus 的前后端分离系统，管理院系答辩从分组、小组评分、大组终评到成绩汇总的全流程。JWT + Spring Security 区分超级管理员、院系管理员、教师、组长四类角色；综合成绩按指导、评阅、答辩三项加权合成，组长端可生成 AI 评语。文档批量导出功能仍在开发中。',
    features: [
      'JWT 登录与角色权限',
      '院系、教师、学生管理',
      '答辩小组与评分指标配置',
